...
public class UtilGP {
     ...
     * environment and theme set in {@link ConstantsGP}.
     *
     * @param context is the caller's context.
     */
    public static PaymentsClient createPaymentsClient(Context context) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(ActivityGP.PAYMENTS_ENVIRONMENT).build();
     ...
     *
     * <p>NOTE: molpay is RMS payment gateway for Google Pay
     *
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(ConstantsGP.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(ConstantsGP.SUPPORTED_METHODS);
    }
...
//    parameters.put("billingAddressParameters", billingAddressParameters);
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", ActivityGP.COUNTRY_CODE);
        transactionInfo.put("currencyCode", ActivityGP.CURRENCY_CODE);
...
//      paymentDataRequest.put("shippingAddressParameters", shippingAddressParameters);
    ...
    /**
     * Converts cents to a string format accepted by {@link UtilGP#getPaymentDataRequest}.
     *
